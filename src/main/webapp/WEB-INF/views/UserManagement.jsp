              ...
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                          <div class="form-group col-md-12">
                              <label class="col-md-2 control-lable" for="file">NickName</label>
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.nickname" class="form-control input-sm" placeholder="Enter your nickname [This field is validation free]"/>
                              </div>
                          </div>
                      </div>
